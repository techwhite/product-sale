...
import com.ecom.productsale.model.SaleItem;
import com.ecom.productsale.model.SaleRequest;
import com.ecom.productsale.model.SaleResponse;
import com.ecom.productsale.model.SaleWithDiscountItem;
...
/*
 ...
 todo: update to align with best practice described in exceptionhandler
 */
...
public class SaleService {
    ...
    public SaleResponse sale(List<SaleRequest> requestList) {
        ...
        for (int i = 0; i < requestList.size(); i++) {
            ...
            float price = entity.get().getPrice();

            BigDecimal revenue = BigDecimal.valueOf(price).multiply(BigDecimal.valueOf(productReq.getQuantity()));
